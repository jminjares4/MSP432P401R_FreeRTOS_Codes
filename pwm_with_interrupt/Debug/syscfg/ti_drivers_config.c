...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* CONFIG_GPIO_BUTTON1 : LaunchPad Button S1 (Left) */
    GPIOMSP432_P1_1 | GPIO_DO_NOT_CONFIG,
    /* CONFIG_GPIO_BUTTON2 : LaunchPad Button S2 (Right) */
    GPIOMSP432_P1_4 | GPIO_DO_NOT_CONFIG,
    /* CONFIG_GPIO_GREEN : LaunchPad LED 2 Green */
...
const PWMTimerMSP432_HWAttrsV2 pwmTimerMSP432HWAttrs[CONFIG_PWM_COUNT] = {
    ...
    /* LaunchPad LED 2 Blue */
    {
        ...
        .pwmPin = PWMTimerMSP432_P2_2_TA0CCR1A, /* P2_2 */
    },
};
