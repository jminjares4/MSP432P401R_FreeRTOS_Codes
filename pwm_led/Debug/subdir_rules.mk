...
build-706360673:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-706360673-inproc

build-706360673-inproc: ../pwm_led.syscfg
	@echo 'Building file: "$<"'
...
syscfg/ti_drivers_config.c: build-706360673 ../pwm_led.syscfg
syscfg/ti_drivers_config.h: build-706360673
syscfg/syscfg_c.rov.xs: build-706360673
syscfg/: build-706360673
